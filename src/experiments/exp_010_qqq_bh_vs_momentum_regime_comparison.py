...
Experiment:
EXP-010_QQQ_BH_VS_MOMENTUM_REGIME_COMPARISON

QuantConnect project:
04 - Cross-Strategy Regime Analysis

Purpose:
Compare QQQ buy-and-hold with the execution-aligned 60-day momentum strategy
under identical prior-data volatility and trend regime labels.
...
Timing rule:
Both strategies are assigned to the same regime label calculated after the
prior daily close. Momentum returns come from actual QuantConnect portfolio
value, while buy-and-hold returns come from QQQ's observed daily return.
"""
...
class CrossStrategyRegimeAnalysis(QCAlgorithm):
    ...
    def on_end_of_algorithm(self):
        self.debug("EXP-010_QQQ_BH_VS_MOMENTUM_REGIME_COMPARISON")
        ...
        self.debug("Momentum returns: daily changes in QuantConnect portfolio value")
        self.debug("Buy-and-hold returns: QQQ daily close-to-close returns")
        ...
        self.debug("MOMENTUM PORTFOLIO OVERALL SUMMARY")
        self.log_summary(
            "actual_all_days",
            self.daily_records,
            "actual_portfolio_return",
        ...
        self.debug("MOMENTUM PORTFOLIO VOLATILITY REGIME SUMMARY")
        ...
        self.debug("MOMENTUM PORTFOLIO TREND REGIME SUMMARY")
        self.log_group_summary(
            classified_records,
            "trend_regime",
            "actual_portfolio_return",
        ...
        self.debug("MOMENTUM PORTFOLIO COMBINED REGIME SUMMARY")
        self.log_group_summary(
            classified_records,
            "combined_regime",
            "actual_portfolio_return",
        ...
        self.debug("BUY-AND-HOLD OVERALL SUMMARY")
        self.log_summary("buy_and_hold_all_days", self.daily_records, "qqq_return")

        self.debug("BUY-AND-HOLD VOLATILITY REGIME SUMMARY")
        self.log_group_summary(
            classified_records,
            "volatility_regime",
            "qqq_return",
        ...
        self.debug("BUY-AND-HOLD TREND REGIME SUMMARY")
        self.log_group_summary(
            classified_records,
            "trend_regime",
            "qqq_return",
        ...
        self.debug("BUY-AND-HOLD COMBINED REGIME SUMMARY")
        self.log_group_summary(
            classified_records,
            "combined_regime",
            "qqq_return",
        ...
        return_difference = actual_cumulative - buy_and_hold_cumulative

        self.debug(
            "DIRECT STRATEGY COMPARISON: "
            f"momentum_cum_return={actual_cumulative:.2%}, "
